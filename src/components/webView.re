...
let make =
    (
      ...
      ~onError: option(ReactNative.WebView.webViewErrorEvent => unit)=?,
      ~onLoad: option(ReactNative.WebView.webViewNavigationEvent => unit)=?,
      ~onLoadEnd: option(ReactNative.WebView.webViewErrorOrNavigation => unit)=?,
      ~onLoadStart: option(ReactNative.WebView.webViewNavigationEvent => unit)=?,
      ...
      ~onMessage: option(ReactNative.WebView.webViewMessageEvent => unit)=?,
