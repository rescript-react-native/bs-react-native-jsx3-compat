...
let make:
  (
    ...
    ~onError: ReactNative.WebView.webViewErrorEvent => unit=?,
    ~onLoad: ReactNative.WebView.webViewNavigationEvent => unit=?,
    ~onLoadEnd: ReactNative.WebView.webViewErrorOrNavigation => unit=?,
    ~onLoadStart: ReactNative.WebView.webViewNavigationEvent => unit=?,
    ...
    ~onMessage: ReactNative.WebView.webViewMessageEvent => unit=?,
